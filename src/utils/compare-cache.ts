import { COMPARE_AUTH_KEY, COMPARE_DEFAULT_TTL_MS, COMPARE_STORAGE_KEY, COMPARE_TIMESTAMP_KEY } from "./constants";
import { createIdSetCache } from "./id-set-cache";

const cache = createIdSetCache({
  storageKey: COMPARE_STORAGE_KEY,
  timestampKey: COMPARE_TIMESTAMP_KEY,
  authKey: COMPARE_AUTH_KEY,
  defaultTtlMs: COMPARE_DEFAULT_TTL_MS,
});
